...
return  array(
    ...
    'DB_SQL_BUILD_QUEUE'    => 'Tae',   // SQL缓存队列的缓存方式 支持 file xcache和apc
    ...
    'DATA_CACHE_TYPE'		=> 'Tae',  // 数据缓存类型,支持:File|Db|Apc|Memcache|Shmop|Sqlite|Xcache|Apachenote|Eaccelerator
